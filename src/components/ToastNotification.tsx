    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
      ...
      <div className="relative bg-white rounded-3xl shadow-[0_25px_70px_rgba(83,91,115,0.25)] border border-cream p-10 max-w-md w-full">
        ...
        <div className="flex flex-col items-center text-center gap-5">
          ...
          {/* Heart Icon */}
          <div className="w-14 h-14 bg-[#F2E9E9] rounded-full flex items-center justify-center shadow-inner">
            <FontAwesomeIcon icon={faHeart} className="w-12 h-12 text-blush" />
          </div>
          ...
          <p className="text-xs text-mauve/60 italic">
            Tap the ✕ to close
          </p>
        </div>
      </div>
