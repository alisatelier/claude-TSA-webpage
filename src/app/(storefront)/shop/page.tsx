...
export default function ShopPage() {
  ...
  const sortedProducts = useMemo(() => {
    ...
    if (sortBy === "price-asc")
      result.sort(
        (a, b) => getProductPrice(a.prices) - getProductPrice(b.prices),
      );
    if (sortBy === "price-desc")
      result.sort(
        (a, b) => getProductPrice(b.prices) - getProductPrice(a.prices),
      );
    return result;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-[0_4px_12px_rgba(83,91,115,0.08)]">
              ...
              <p className="text-navy/80 leading-relaxed text-sm">
                The guidebooks, journal, and cards are thoughtfully printed by a
                local Calgary small business,{" "}
                <Link
                  href="https://littlerockprinting.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline decoration-navy/40 hover:decoration-navy transition-colors"
                >
                ...
                <br />
                <br />
                Supporting local craftsmanship matters deeply to The Spirit
                Atelier, and their care, precision, and consistency have helped
                bring each project including core offerings and physical
                marketing beautifully to life.
                <br />
                <br />
                Their partnership has been an integral and valued part of this
                work.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-[0_4px_12px_rgba(83,91,115,0.08)]">
              ...
              <p className="text-navy/80 leading-relaxed text-sm mb-4">
                Each piece has been shaped through direct, intentional work —
                not mass production.
              </p>
              <ul className="space-y-2 text-sm text-navy/80">
                <li className="flex items-start gap-2">
                  <span className="text-blush mt-0.5">•</span>
                  The runes and spirit boards are cast from raw materials by
                  hand.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blush mt-0.5">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-blush mt-0.5">•</span>
                  Each drawstring bag is finished with a logo placed by the
                  creator herself.
                </li>
              </ul>
              <p className="text-navy/80 leading-relaxed text-sm mt-4 italic">
                Every step carries the imprint of care, time, and personal
                attention.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {sortedProducts.map((product) => (
              <ProductCard
                ...
                product={product}
                syncIndex={
                  SYNCED_RUNE_PRODUCTS.includes(product.id)
                    ? runesSyncIndex
                    : undefined
                }
